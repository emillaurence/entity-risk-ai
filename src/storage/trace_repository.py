    ...
    def save_trace(self, trace: InvestigationTrace) -> str:
        ...
        self._repo.run_query(
            ...
            ON CREATE SET
                ...
                t.auth_provider = $auth_provider,
                t.session_id    = $session_id,
                t.gateway_mode  = $gateway_mode,
                t.query         = $query,
                t.question      = $question,
            ...
            """,
            {
                ...
                "auth_provider": trace.auth_provider,
                "session_id":    trace.session_id,
                "gateway_mode":  trace.gateway_mode,
    ...
    def load_trace(self, trace_id: str) -> dict:
        ...
        trace_rows = self._repo.run_query(
            ...
            RETURN
                ...
                t.auth_provider       AS auth_provider,
                t.session_id          AS session_id,
                t.gateway_mode        AS gateway_mode,
                t.mode                AS mode,
